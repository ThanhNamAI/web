  ...
  return <StudyShell>
    <div className="page-wrap overview-page">
      ...
      <section className="hero-panel">
        <div className="hero-copy"><span className="hero-kicker">BUỔI HỌC ĐƯỢC ĐỀ XUẤT</span><h2>Chạm đích <i>800+</i><br />bằng nhịp học của bạn.</h2><p>18 phút tập trung: ôn 12 thẻ đến hạn, giải 1 tình huống nghe và chinh phục thử thách tốc độ.</p><div className="hero-meta"><span><Clock3 /> 18 phút</span><span><Target /> 42 XP</span></div><div className="hero-actions"><Link href="/learn" className="primary-cta"><Play fill="currentColor" /> Bắt đầu buổi học <ArrowRight /></Link><Link href="/diagnostic" className="secondary-cta">Kiểm tra đầu vào 10 phút</Link></div></div>
